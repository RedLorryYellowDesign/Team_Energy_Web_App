...
"""
    Future Applications
	•	We are proud of the models we have made as they demonstrate a good proof of concept around energy prediction.  However, with better data, there is potential to enrich the model to address the following:
